...
Display.prototype.add = function (book) {
  ...
  let uiString = `<tr>              
                        ...
                        <td>${book.author}</td>
                        <td>${book.type}</td>
                        <td style="width: 8rem;"><button type="button"style="margin-left:1.25rem;" class="btn btn-secondary"
                        style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;" id="delete">
                  Delete
                </button></td>
                    </tr>`;
...
//     localStorage.setItem('Book', JSON.stringify(savedBooks));
//    }
